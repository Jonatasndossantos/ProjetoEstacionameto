    ...
    <main class="d-flex" style="height: 100%;">
        ...
        <div class="d-flex flex-column flex-shrink-0 p-3 bg-body-tertiary" style="width: 280px;">
            ...
            <ul class="nav nav-pills flex-column mb-auto">
              ...
              <li>
                <a href="../main.html" class="nav-link link-body-emphasis">
                ...
                <div class="card shadow" style="height: 85%; --bs-gutter-x: 0;">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <a href="ControllerMensalista.php"><button class="btn btn-primary ms-3">Adicionar</button></a>
                        </div>
                    </div>
                    <div class="card-body">
