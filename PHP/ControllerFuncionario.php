...
<head>
  ...
  position: absolute;
  top: 0;
  left: 280px; /* adjust this value to match the width of your sidebar */
  width: calc(100% - 280px); /* adjust this value to match the width of your sidebar */
  height: 100vh;
}
    </style>
</head>
...
<main class="d-flex grid-container" style="height: 100vh;">
    ...
    <div class="d-flex flex-column flex-shrink-0 p-3 bg-body-tertiary" style="width: 280px; height: 100%; position: fixed">
        <a href="VerFuncionario.php" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto link-body-emphasis text-decoration-none">
  ...
  <main>
    ...
    <div class="card-header d-flex align-items-center" style="--bs-gutter-x: 0; position: fixed">
        ...
        <a href="VerEntradaeSaida.html"><div class="d-flex justify-content-center align-items-center rounded-pill bg-primary" style="width: 190px; height: 40px;">
        ...
        <a href="VerUsuario.html"><div class="d-flex justify-content-center align-items-center rounded-pill bg-primary" style="width: 180px; height: 40px;">
    ...
    <div class="row g-5">
      <div class="col-md-5 col-lg-4 order-md-last">
        <h4 class="d-flex justify-content-between align-items-center mb-3">
          <span class="text-primary">Preço</span>
...
<!--Inicio formulario-->
        <h4 class="mb-3">Cadastre o Mensalista</h4>
        <form class="needs-validation" novalidate="">
          ...
          <h4 class="mb-3">Cadastre o Cargo</h4>
        <form class="needs-validation" novalidate="">
          <div class="row g-3">
          ...
          <a href="VerMensalista.php"><button class="w-100 btn btn-primary btn-lg" type="submit">Cadastrar
          <?php
                try{ 
